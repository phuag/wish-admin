  ...
  <section>
    ...
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <el-form :inline="true" :model="filters">
        <el-form-item>
          <el-input v-model="filters.name" placeholder="姓名" suffix-icon="search"></el-input>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" v-on:click="getStaffs">查询</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <!--列表-->
    <el-table :data="staffs" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
